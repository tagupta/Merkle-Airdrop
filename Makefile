...
ROOT := 0xe8f1efde218b84d090406d8b34328d16340ff345c3f46ad37922147238b7e899
...
deploy-zk-sepolia:
	forge create src/MerkleAirdrop.sol:MerkleAirdrop --rpc-url ${ZKSYNC_SEPOLIA_RPC_URL} --constructor-args ${ROOT} $(shell forge create src/BagelToken.sol:BagelToken --rpc-url ${ZKSYNC_SEPOLIA_RPC_URL} --account mySepoliaAcc1 --legacy --zksync | grep "Deployed to:" | awk '{print $$3}') --from 0x0Ad593a3A713609eba3b2b8b821315F93B635335 --legacy --zksync --interactive
